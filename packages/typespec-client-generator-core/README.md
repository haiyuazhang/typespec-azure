...
| [`@azure-tools/typespec-client-generator-core/no-request-suffix`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/no-request-suffix)           | Model names ending with 'Request' should be renamed to 'Content' or another appropriate suffix. |
